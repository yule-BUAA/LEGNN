...
from utils.mini_batch_utils import train_model, evaluate_model, get_final_performance
...
if __name__ == '__main__':
    ...
    for run in range(args['num_runs']):
        ...
        # convert to cpu to avoid out of memory of cuda
        model = model.cpu()
        args['device'] = 'cpu'

        # evaluate the best model
        train_accuracy, val_accuracy, test_accuracy = get_final_performance(model, evaluate_graph, labels, args['predict_category'],
                                                                            train_idx, valid_idx, test_idx, dataset_name=args['dataset'], device=args['device'])
